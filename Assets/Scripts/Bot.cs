...
public class Bot : MonoBehaviour
{
    ...
    float force = 30; // ball impact force
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.CompareTag("Ball")){ // if we collide with the ball 
            ...
            Vector3 V = dir.normalized * currentShot.hitForce + new Vector3(0, currentShot.upForce, 0); // set force to the ball
